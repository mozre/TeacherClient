 ...
 * Created by mozre
 */
public class FinishedTaskFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, EndlessRecyclerView.OnLoadMoreListener, CommonFragmentView {
        ...
        public void onClick(View v) {
            if (v == container) {
                if (isShowCheckBox) {
                    ...
                    startActivityForResult(intent, MainActivity.FINISHED_TO_NEW_EXAM_REQUEST_CODE);
                }
